...
class __TwigTemplate_e9c058448dbc147719868011779d48d35a0ea053bee1cc81c004368873e02ea5 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 3
        echo "    <div class=\"restpageco bodydark\">
    ";
        // line 4
        if (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 4, $this->source); })()), "session", [], "any", false, false, false, 4), "get", [0 => "site"], "method", false, false, false, 5), "sitelogo", [], "any", false, false, false, 6), "")) {
            // line 8
            echo "                                                <img src=\"";
            ...
            echo "\" class=\"logocobase\"/>
                                            ";
        } else {
            // line 10
            echo "                                                <img src=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 10, $this->source); })()), "session", [], "any", false, false, false, 10), "get", [0 => "site"], "method", false, false, false, 10), "sitelogo", [], "any", false, false, false, 10), "html", null, true);
            echo "\" class=\"logoco\"/>
                                            ";
        }
        // line 11
...
<form method=\"post\">
    ...
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-control\" required autofocus><br>
...
";
    ...
    {
        return array (  140 => 50,  134 => 37,  126 => 32,  122 => 30,  116 => 27,  112 => 26,  109 => 25,  107 => 24,  104 => 23,  98 => 21,  96 => 20,  85 => 11,  79 => 10,  73 => 8,  71 => 4,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% endblock %}
", "security/login.html.twig", "/Users/kellianchamouard/Desktop/Site BR13 Symfony/belvezerugby/templates/security/login.html.twig");
    }
}
