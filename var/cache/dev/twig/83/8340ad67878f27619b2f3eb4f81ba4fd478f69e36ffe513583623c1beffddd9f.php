...
class __TwigTemplate_e6cb981710dea3ca26fa0c5db6a67f588a7c458fc71f05bc399bbeafcf534b18 extends Template
{
    private $source;
    private $macros = [];
                    ...
                    <div class=\"col-4 col-sm-4 col-md-5 col-lg-5 col-xl-4 padd\">
                        <div class=\"simplebloc\">
                            <div class=\"simplebloctitle\">
                                <span class=\"material-icons\">
                                    pending_actions
                                </span>&nbsp;résultats a ajouter</div>
                            <div class=\"simplebloccontent blocksize\">
                                mettre en place le systeme de résultat a ajouter si matchdate > daydate &&
                                complet == 0
                    ...
                    <div class=\"col-8 col-sm-8 col-md-7 col-lg-7 col-xl-4 padd\">
                        <div class=\"simplebloc\">
                            ...
                            <div class=\"simplebloccontent freesize\">
                                ";
        // line 167
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formdoc"]) || array_key_exists("formdoc", $context) ? $context["formdoc"] : (function () { throw new RuntimeError('Variable "formdoc" does not exist.', 167, $this->source); })()), 'form');
        echo "
                                <hr>
                                    ...
                                    <div class=\"card\">
                                        ...
                                        <div
                                            ...
                                            <div class=\"card-body\">
                                                ...
                                                ";
        // line 196
        if (0 === twig_compare((isset($context["persodoc"]) || array_key_exists("persodoc", $context) ? $context["persodoc"] : (function () { throw new RuntimeError('Variable "persodoc" does not exist.', 196, $this->source); })()), null)) {
            // line 197
            ...
            echo "                                                    ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["persodoc"]) || array_key_exists("persodoc", $context) ? $context["persodoc"] : (function () { throw new RuntimeError('Variable "persodoc" does not exist.', 199, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
                // line 200
                echo "                                                        -
                                                        <b>
                ...
                // line 202
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["id"], "docname", [], "any", false, false, false, 202), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["id"], "docname", [], "any", false, false, false, 202), "html", null, true);
                echo "</a>
                                    ...
                                    <div class=\"card\">
                                        ...
                                        <div
                                            ...
                                            <div class=\"card-body\">
                                                ";
        // line 233
        if (0 === twig_compare((isset($context["alldocs"]) || array_key_exists("alldocs", $context) ? $context["alldocs"] : (function () { throw new RuntimeError('Variable "alldocs" does not exist.', 233, $this->source); })()), null)) {
            // line 234
            echo "                                                    Aucun document pour le moment.
                                                ";
        } else {
            ...
            echo "                                                    ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["alldocs"]) || array_key_exists("alldocs", $context) ? $context["alldocs"] : (function () { throw new RuntimeError('Variable "alldocs" does not exist.', 236, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
                // line 237
                echo "                                                        -
                                                        <b>
                                                            <a class=\"secondlink\" href=\"../docs/";
                // line 239
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["id"], "docname", [], "any", false, false, false, 239), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["id"], "docname", [], "any", false, false, false, 239), "html", null, true);
                echo "</a>
                                                        </b>&nbsp;<span class=\"material-icons\" style=\"font-size:10px\">open_in_new</span><br>
    ...
    {
        return array (  461 => 260,  442 => 243,  439 => 242,  428 => 239,  424 => 237,  419 => 236,  415 => 234,  413 => 233,  384 => 206,  381 => 205,  370 => 202,  366 => 200,  361 => 199,  357 => 197,  355 => 196,  323 => 167,  295 => 141,  292 => 140,  280 => 134,  274 => 131,  271 => 130,  266 => 129,  256 => 121,  254 => 120,  205 => 73,  200 => 71,  197 => 70,  192 => 68,  187 => 67,  185 => 66,  179 => 63,  175 => 62,  169 => 59,  165 => 58,  148 => 43,  146 => 42,  139 => 37,  137 => 36,  133 => 34,  127 => 32,  122 => 30,  117 => 29,  115 => 28,  108 => 23,  102 => 21,  96 => 19,  94 => 18,  89 => 16,  77 => 6,  74 => 5,  71 => 4,  68 => 3,  58 => 2,  35 => 1,);
    }
