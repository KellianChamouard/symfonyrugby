...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AddMatchType' => ['privates', 'App\\Form\\AddMatchType', 'getAddMatchTypeService', true],
            'App\\Form\\AddPlayerType' => ['privates', 'App\\Form\\AddPlayerType', 'getAddPlayerTypeService', true],
            'App\\Form\\AddTeamType' => ['privates', 'App\\Form\\AddTeamType', 'getAddTeamTypeService', true],
            'App\\Form\\ClubType' => ['privates', 'App\\Form\\ClubType', 'getClubTypeService', true],
            'App\\Form\\DirigType' => ['privates', 'App\\Form\\DirigType', 'getDirigTypeService', true],
            'App\\Form\\DocsType' => ['privates', 'App\\Form\\DocsType', 'getDocsTypeService', true],
            'App\\Form\\ModifPlayerType' => ['privates', 'App\\Form\\ModifPlayerType', 'getModifPlayerTypeService', true],
            'App\\Form\\ModifTeamType' => ['privates', 'App\\Form\\ModifTeamType', 'getModifTeamTypeService', true],
            ...
            'App\\Form\\SocialType' => ['privates', 'App\\Form\\SocialType', 'getSocialTypeService', true],
            ...
            'App\\Form\\AddMatchType' => '?',
            'App\\Form\\AddPlayerType' => '?',
            'App\\Form\\AddTeamType' => '?',
            'App\\Form\\ClubType' => '?',
            'App\\Form\\DirigType' => '?',
            'App\\Form\\DocsType' => '?',
            'App\\Form\\ModifPlayerType' => '?',
            'App\\Form\\ModifTeamType' => '?',
            'App\\Form\\NewsType' => '?',
            'App\\Form\\NoteType' => '?',
            'App\\Form\\SiteType' => '?',
            'App\\Form\\SocialType' => '?',
